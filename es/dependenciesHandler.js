    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          command = hasLocalYarn ? "yarn add ".concat(packageName, "@latest -D --registry=http://nexus.medlinker.com/repository/group-npm/") : "npm install ".concat(packageName, "@latest -D --registry=http://nexus.medlinker.com/repository/group-npm/");
